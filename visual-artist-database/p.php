...
<title>Visual Artist Database | P</title>
...
<header role="banner"><h1>Visual Artist Database</h1></header>
  ...
  <section role="main">
      ...
      <tbody>
      	<?php do { ?>
      	  <tr>
      	    <td><?php echo $row_getP['Name']; ?></td>
      	    <td><?php echo $row_getP['Movement']; ?></td>
      	    <td>
				<?php if ($row_getP['YearBirth']==0) {
					echo('Unknown'); }
						else {
							echo $row_getP['YearBirth']; } ?>
            </td>
      	    <td>
				<?php if ($row_getP['YearDeath']==0) {
					echo('Living'); }
						else {
							echo $row_getP['YearDeath']; } ?>
            </td>
      	    <td><?php echo $row_getP['CityBirth']; ?></td>
      	    <td><?php echo $row_getP['SimilarArtists']; ?></td>
   	      </tr>
      	  <?php } while ($row_getP = mysql_fetch_assoc($getP)); ?>
    </tbody>
    </table>
  </section>
