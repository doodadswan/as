...
$query_getI = "SELECT * FROM artists WHERE artists.LastName LIKE 'I%' ORDER BY artists.LastName";
$getI = mysql_query($query_getI, $artists) or die(mysql_error());
$row_getI = mysql_fetch_assoc($getI);
$totalRows_getI = mysql_num_rows($getI);
?>
...
<title>Visual Artist Database | I</title>
...
<meta name="description" content="Visual Artist Database" />
<meta name="author" content="Alex Taylor Swan" />
<title>AlexSwan.com | Visual Artist Database | I</title>
<style type="text/css" media="screen">
@import url("css/style.css");
</style>
<meta name="google-translate-customization" content="f91f6b59f687e07-728df0675eb22298-gf4646ea128908eee-c"></meta>
...
<header role="banner"><h1>Visual Artist Database</h1></header>
  ...
  <section role="main">
      ...
      <tbody>
      	<?php do { ?>
      	  <tr>
      	    <td><?php echo $row_getI['Name']; ?></td>
      	    <td><?php echo $row_getI['Movement']; ?></td>
      	    <td>
				<?php if ($row_getI['YearBirth']==0) {
					echo('Unknown'); }
						else {
							echo $row_getI['YearBirth']; } ?>
            </td>
      	    <td>
				<?php if ($row_getI['YearDeath']==0) {
					echo('Living'); }
						else {
							echo $row_getI['YearDeath']; } ?>
            </td>
      	    <td><?php echo $row_getI['CityBirth']; ?></td>
      	    <td><?php echo $row_getI['SimilarArtists']; ?></td>
   	      </tr>
      	  <?php } while ($row_getI = mysql_fetch_assoc($getI)); ?>
    </tbody>
    </table>
  </section>
